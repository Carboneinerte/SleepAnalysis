...
if (is_empty(which(names_col == para_))){
  print("///// Wrong column name, just copy-paste, please, you know you can't type properly \\\\\\")
}

if (!is_empty(grep("Temp_Mean", para_)) | !is_empty(grep("Activity_Mean", para_))){
...
png_name = paste0(png_exp_name,"/",names(col_to_add),".png")
png(png_name,         # File name
