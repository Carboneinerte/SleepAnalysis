...
if (grepl("acute",ID2,ignore.case = T)){ #### Only work because light on at midnight. Might need to be improved
...
for (y in ZT){
  ...
  names(Bouts_mean_table) = c("Bouts_W_Mean (min)","Bouts_W_Median (min)","Bouts_W_Max (min)","Bouts_W_SD","Bouts_W_n",
                              "Bouts_S_Mean (min)","Bouts_S_Median (min)","Bouts_S_Max (min)","Bouts_S_SD","Bouts_S_n")
}
