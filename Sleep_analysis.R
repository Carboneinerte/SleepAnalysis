...
#### To automatically process all files with a certain folders (Select then ctrl+shift+C to comment/uncomment)
# base_folder = getwd()
# setwd("input")
# a_unique = unique(dirname(list.files(pattern = "csv", recursive = T, ignore.case = T))) #Change the pattern to choose more precisely an experiment, a mouse ID, etc.
