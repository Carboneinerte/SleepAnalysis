...
for (t in date){
  ...
  df$Wake_percent = df$Wake / 720 * 100
  df$Sleep_percent = df$Sleep / 720 * 100
  df$Paradoxical_percent = df$Paradoxical / 720 * 100
  df$Uncategorized_percent = (720-df$Sum)/720*100
  #TODO: Fist and last values do not make sense to be divided by 720. Use time to calculate better approx?
...
### Combine all days
if (grepl("baseline",ID2,ignore.case = T)){
  date_baseline=date[1:length(date)-1]
  date_acute=date[length(date)]
  
  df_one_baseline = data.frame()
  for (t in date_baseline){
    temp = read.xlsx(wb, sheet=t)
    df_one_baseline = rbind(df_one_baseline,temp)
  }
  df_one_baseline = df_one_baseline[df_one_baseline$Sum != 0,]
  
  addWorksheet(wb2, "State - Baseline - All days")
  writeData(wb2,"State - Baseline - All days", x=df_one_baseline)
  
  df_one_acute = data.frame()
  
  for (t in date_acute){
    temp = read.xlsx(wb, sheet=t)
    df_one_acute = rbind(df_one_acute,temp)
  }
  df_one_acute = df_one_acute[df_one_acute$Sum != 0,]
  
  addWorksheet(wb2, "State - Acute - All days")
  writeData(wb2,"State - Acute - All days", x=df_one_acute)
  ...
  Stage_sleep = rep(c("Wake","Sleep","Paradoxical"),2)
    ...
    Mean_Phase_one_baseline = c(mean(df_one_baseline$Wake[df_one_baseline$ZT < 12]),mean(df_one_baseline$Sleep[df_one_baseline$ZT < 12]),mean(df_one_baseline$Paradoxical[df_one_baseline$ZT < 12]),
                       mean(df_one_baseline$Wake[df_one_baseline$ZT >= 12]),mean(df_one_baseline$Sleep[df_one_baseline$ZT >= 12]),mean(df_one_baseline$Paradoxical[df_one_baseline$ZT >= 12]))
    
    SD_Phase_one_baseline = c(sd(df_one_baseline$Wake[df_one_baseline$ZT < 12]),
                     sd(df_one_baseline$Sleep[df_one_baseline$ZT < 12]),
                     sd(df_one_baseline$Paradoxical[df_one_baseline$ZT < 12]),
                     sd(df_one_baseline$Wake[df_one_baseline$ZT >= 12]),
                     sd(df_one_baseline$Sleep[df_one_baseline$ZT >= 12]),
                     sd(df_one_baseline$Paradoxical[df_one_baseline$ZT >= 12])
    )
    n_phase_one_baseline = c(length(df_one_baseline$Wake[df_one_baseline$ZT < 12]),
                    length(df_one_baseline$Sleep[df_one_baseline$ZT < 12]),
                    length(df_one_baseline$Paradoxical[df_one_baseline$ZT < 12]),
                    length(df_one_baseline$Wake[df_one_baseline$ZT >= 12]),
                    length(df_one_baseline$Sleep[df_one_baseline$ZT >= 12]),
                    length(df_one_baseline$Paradoxical[df_one_baseline$ZT >= 12])
    )
    
    df_mean_one_baseline = data.frame(Phase, Stage_sleep, Mean_Phase_one_baseline, SD_Phase_one_baseline, n_phase_one_baseline)
  
  addWorksheet(wb2, "Phase - Baseline - Mean")
  writeData(wb2, sheet="Phase - Baseline - Mean", x= df_mean_one_baseline)
  
  Mean_Phase_one_acute = c(mean(df_one_acute$Wake[df_one_acute$ZT < 12]),mean(df_one_acute$Sleep[df_one_acute$ZT < 12]),mean(df_one_acute$Paradoxical[df_one_acute$ZT < 12]),
                              mean(df_one_acute$Wake[df_one_acute$ZT >= 12]),mean(df_one_acute$Sleep[df_one_acute$ZT >= 12]),mean(df_one_acute$Paradoxical[df_one_acute$ZT >= 12]))
  
  SD_Phase_one_acute = c(sd(df_one_acute$Wake[df_one_acute$ZT < 12]),
                            sd(df_one_acute$Sleep[df_one_acute$ZT < 12]),
                            sd(df_one_acute$Paradoxical[df_one_acute$ZT < 12]),
                            sd(df_one_acute$Wake[df_one_acute$ZT >= 12]),
                            sd(df_one_acute$Sleep[df_one_acute$ZT >= 12]),
                            sd(df_one_acute$Paradoxical[df_one_acute$ZT >= 12])
  )
  n_phase_one_acute = c(length(df_one_acute$Wake[df_one_acute$ZT < 12]),
                           length(df_one_acute$Sleep[df_one_acute$ZT < 12]),
                           length(df_one_acute$Paradoxical[df_one_acute$ZT < 12]),
                           length(df_one_acute$Wake[df_one_acute$ZT >= 12]),
                           length(df_one_acute$Sleep[df_one_acute$ZT >= 12]),
                           length(df_one_acute$Paradoxical[df_one_acute$ZT >= 12])
  )
  
  df_mean_one_acute = data.frame(Phase, Stage_sleep, Mean_Phase_one_acute, SD_Phase_one_acute, n_phase_one_acute)
  
  addWorksheet(wb2, "Phase - acute - Mean")
  writeData(wb2, sheet="Phase - acute - Mean", x= df_mean_one_acute)
  
  date_phase_baseline = c(date_baseline,date_baseline)
  date_phase_baseline = sort(date_phase_baseline)
  Phase_day = rep(c("Light","Dark"),length(date_phase_baseline)/2)
  df3_baseline = data.frame(date_phase_baseline, Phase_day)
  temp_df3 = c()
  
  for (t in date_baseline){
    Mean_Light_day = c(mean(df_one_baseline$Wake[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       mean(df_one_baseline$Sleep[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       mean(df_one_baseline$Paradoxical[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       sd(df_one_baseline$Wake[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       sd(df_one_baseline$Sleep[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       sd(df_one_baseline$Paradoxical[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       length(df_one_baseline$Wake[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       length(df_one_baseline$Sleep[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]),
                       length(df_one_baseline$Paradoxical[df_one_baseline$ZT<12 & df_one_baseline$Date ==t]))
    
    Mean_Dark_day = c(mean(df_one_baseline$Wake[df_one_baseline$ZT>=12 & df_one_baseline$Date ==t]),
                      mean(df_one_baseline$Sleep[df_one_baseline$ZT>=12 & df_one_baseline$Date ==t]),
                      mean(df_one_baseline$Paradoxical[df_one_baseline$ZT>=12 & df_one_baseline$Date ==t]),
                      sd(df_one_baseline$Wake[df_one_baseline$ZT>=12&df_one_baseline$Date ==t]),
                      sd(df_one_baseline$Sleep[df_one_baseline$ZT>=12&df_one_baseline$Date ==t]),
  ...
  df3_baseline = cbind(df3_baseline,temp_df3)
  names(df3_baseline) = c("Date","Phase","Mean_Wake","Mean_Sleep","Mean_Paradoxical","SD_Wake","SD_Sleep","SD_Paradoxical","N_Wake","N_Sleep","N_Paradoxical")
  rownames(df3_baseline)=NULL
  df3_baseline = df3_baseline[df3_baseline$Mean_Wake !=0,]
  
  addWorksheet(wb2, "Phase - Baseline - All Days")
  writeData(wb2, sheet="Phase - Baseline - All Days", x= df3_baseline)  
  
  date_phase_acute = c(date_acute,date_acute)
  date_phase_acute = sort(date_phase_acute)
  Phase_day = rep(c("Light","Dark"),length(date_phase_acute)/2)
  df3_acute = data.frame(date_phase_acute, Phase_day)
  temp_df3 = c()
  
  for (t in date_acute){
    Mean_Light_day = c(mean(df_one_acute$Wake[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       mean(df_one_acute$Sleep[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       mean(df_one_acute$Paradoxical[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       sd(df_one_acute$Wake[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       sd(df_one_acute$Sleep[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       sd(df_one_acute$Paradoxical[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       length(df_one_acute$Wake[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       length(df_one_acute$Sleep[df_one_acute$ZT<12 & df_one_acute$Date ==t]),
                       length(df_one_acute$Paradoxical[df_one_acute$ZT<12 & df_one_acute$Date ==t]))
    
    Mean_Dark_day = c(mean(df_one_acute$Wake[df_one_acute$ZT>=12 & df_one_acute$Date ==t]),
                      mean(df_one_acute$Sleep[df_one_acute$ZT>=12 & df_one_acute$Date ==t]),
                      mean(df_one_acute$Paradoxical[df_one_acute$ZT>=12 & df_one_acute$Date ==t]),
                      sd(df_one_acute$Wake[df_one_acute$ZT>=12&df_one_acute$Date ==t]),
                      sd(df_one_acute$Sleep[df_one_acute$ZT>=12&df_one_acute$Date ==t]),
  ...
  df3_acute = cbind(df3_acute,temp_df3)
  
  names(df3_acute) = c("Date","Phase","Mean_Wake","Mean_Sleep","Mean_Paradoxical","SD_Wake","SD_Sleep","SD_Paradoxical","N_Wake","N_Sleep","N_Paradoxical")
  rownames(df3_acute)=NULL
  df3_acute = df3_acute[df3_acute$Mean_Wake !=0,]
  
  addWorksheet(wb2, "Phase - Acute - All Days")
  writeData(wb2, sheet="Phase - Acute - All Days", x= df3_acute)
  
  df_ZT_Mean_baseline = data.frame(ZT)
  mean_table = data.frame()
  for (y in ZT){
    ZT_mean = c(mean(df_one_baseline$Wake[df_one_baseline$ZT == y]),mean(df_one_baseline$Sleep[df_one_baseline$ZT == y]),mean(df_one_baseline$Paradoxical[df_one_baseline$ZT == y]),
                sd(df_one_baseline$Wake[df_one_baseline$ZT ==y]),sd(df_one_baseline$Sleep[df_one_baseline$ZT ==y]),sd(df_one_baseline$Paradoxical[df_one_baseline$ZT ==y]),
                length(df_one_baseline$Wake[df_one_baseline$ZT == y]),length(df_one_baseline$Sleep[df_one_baseline$ZT==y]),length(df_one_baseline$Paradoxical[df_one_baseline$ZT==y]),
                ...
                mean(df_one_baseline$cluster1[df_one_baseline$ZT == y]),mean(df_one_baseline$cluster2[df_one_baseline$ZT == y]),mean(df_one_baseline$cluster3[df_one_baseline$ZT == y]),
                mean(df_one_baseline$cluster4[df_one_baseline$ZT == y]),mean(df_one_baseline$cluster5[df_one_baseline$ZT == y]),mean(df_one_baseline$cluster6[df_one_baseline$ZT == y]),
                sd(df_one_baseline$cluster1[df_one_baseline$ZT ==y]),sd(df_one_baseline$cluster2[df_one_baseline$ZT ==y]),sd(df_one_baseline$cluster3[df_one_baseline$ZT ==y]),
                sd(df_one_baseline$cluster4[df_one_baseline$ZT ==y]),sd(df_one_baseline$cluster5[df_one_baseline$ZT ==y]),sd(df_one_baseline$cluster6[df_one_baseline$ZT ==y])
    )
    
    mean_table = rbind(mean_table, ZT_mean)
    names(mean_table) = c("Wake","Sleep","Paradoxical","Wake_SD","Sleep_SD","Paradoxical_SD",
                          # "N_Wake","N_Sleep","N_Paradoxical",
  ...
  df_ZT_Mean_baseline = cbind(df_ZT_Mean_baseline,mean_table)
  
  addWorksheet(wb2, "ZT - Baseline - Mean")
  writeData(wb2,"ZT - Baseline - Mean", x=df_ZT_Mean_baseline)
  
    df_ZT_Mean_acute = data.frame(ZT)
  mean_table = data.frame()
  for (y in ZT){
    ZT_mean = c(mean(df_one_acute$Wake[df_one_acute$ZT == y]),mean(df_one_acute$Sleep[df_one_acute$ZT == y]),mean(df_one_acute$Paradoxical[df_one_acute$ZT == y]),
                sd(df_one_acute$Wake[df_one_acute$ZT ==y]),sd(df_one_acute$Sleep[df_one_acute$ZT ==y]),sd(df_one_acute$Paradoxical[df_one_acute$ZT ==y]),
                length(df_one_acute$Wake[df_one_acute$ZT == y]),length(df_one_acute$Sleep[df_one_acute$ZT==y]),length(df_one_acute$Paradoxical[df_one_acute$ZT==y]),
                # nrow(RawData[RawData$rodent_sleep == "W" & RawData$ZT == y,])/nrow(RawData[RawData$ZT == y,])*100,
                # nrow(RawData[RawData$rodent_sleep == "S" & RawData$ZT == y,])/nrow(RawData[RawData$ZT == y,])*100,
                # nrow(RawData[RawData$rodent_sleep == "P" & RawData$ZT == y,])/nrow(RawData[RawData$ZT == y,])*100,
                mean(df_one_acute$cluster1[df_one_acute$ZT == y]),mean(df_one_acute$cluster2[df_one_acute$ZT == y]),mean(df_one_acute$cluster3[df_one_acute$ZT == y]),
                mean(df_one_acute$cluster4[df_one_acute$ZT == y]),mean(df_one_acute$cluster5[df_one_acute$ZT == y]),mean(df_one_acute$cluster6[df_one_acute$ZT == y]),
                sd(df_one_acute$cluster1[df_one_acute$ZT ==y]),sd(df_one_acute$cluster2[df_one_acute$ZT ==y]),sd(df_one_acute$cluster3[df_one_acute$ZT ==y]),
                sd(df_one_acute$cluster4[df_one_acute$ZT ==y]),sd(df_one_acute$cluster5[df_one_acute$ZT ==y]),sd(df_one_acute$cluster6[df_one_acute$ZT ==y])
    )
  ...
  df_ZT_Mean_acute = cbind(df_ZT_Mean_acute,mean_table)
  
  addWorksheet(wb2, "ZT - acute - Mean")
  writeData(wb2,"ZT - acute - Mean", x=df_ZT_Mean_acute)
...
for (y in ZT){
  ...
  names(mean_table) = c("Wake","Sleep","Paradoxical","Wake_SD","Sleep_SD","Paradoxical_SD","N_Wake","N_Sleep","N_Paradoxical",
                        "Percent_Wake","Percent_Sleep","Percent_Paradoxical","Cluster1","Cluster2","Cluster3","Cluster4","Cluster5","Cluster6",
                        "Cluster1_SD","Cluster2_SD","Cluster3_SD","Cluster4_SD","Cluster5_SD","Cluster6_SD"
  )
}
...
names(onset_date) = c("Date", "First_Sleep_30s_ZT0 (s)","First_Wake_30s_ZT12 (s)")
...
#### Loop #####
#TODO: ADPT TO NEW FILE CLUSTERD FILES
